function lookup() {
    ...
    div.innerHTML = "<button class='btn btn-lg btn-primary search-button' type='button' onclick='lookup()'>Loookup</button><span class='spinner-border text-center loading-indicator' role='status'></span>"
    ...
    div.innerHTML = "<button class='btn btn-lg btn-primary search-button' type='button' onclick='lookup()'>Loookup</button>"
}